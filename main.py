...
from config import BLOCKCHAIN_RPC_URL, CONTRACT_ADDRESS, IPFS_API_ADDR, MANUFACTURE_PUBLIC_KEY_PATH, DEVICE_CPABE_SECRET_KEY
...
async def main():
    ...
    update_manager = UpdateManager(blockchain_service, ipfs_client, device_ecdsa, cpabe, group, public_key, DEVICE_CPABE_SECRET_KEY)
